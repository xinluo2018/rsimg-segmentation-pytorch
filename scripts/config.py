...
#### ------------- Model -------------
model_name = 'watnet'  ### option: deeplabv3plus_mobilev2 (default), unet, deeplabv3plus, hrnet, watnet, gmnet
...
path_weights_save = 'model_trained/' + model_save_name+'_weights.pth'
path_metrics_save = 'model_trained/' + model_save_name + '_metrics.csv'
